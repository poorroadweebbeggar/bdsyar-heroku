...
?>
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> itemtype="https://schema.org/Article" itemscope="itemscope">
		...
		<div class="item-content<?php echo esc_attr( $item_content_class ); ?>">
			...
			<footer
				class="entry-footer entry-footer-top"><?php exs_entry_meta( false, true, true, false, true ); ?></footer>
			<!-- .entry-footer -->

			<footer
				class="entry-footer entry-footer-author"><?php exs_entry_meta( true, false, false, false, false ); ?></footer>
			<!-- .entry-footer -->
